...
class AddressBook extends Module
{
    ...
    protected function show()
    {
        ...
        $objAddresses = Address::findForMember(Isotope::getEnvironment()->getMember()->id);
    ...
    protected function edit($intAddressId=0)
    {
        ...
        $objAddress = Address::findOneForMember($intAddressId, Isotope::getEnvironment()->getMember()->id);

        if (null === $objAddress) {
            $objAddress = Address::createForMember(Isotope::getEnvironment()->getMember()->id);
        }
    ...
    {
        if (($objAddress = Address::findOneForMember($intAddressId, Isotope::getEnvironment()->getMember()->id)) !== null) {
            $objAddress->delete();
        }
